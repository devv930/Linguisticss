...
const courses100 = [
    ...
    },
    {
        ...
        topics: [
            {
                title: "English Communication: Spoken and Written",
                explanation: "Effective communication in English involves both spoken and written forms. Spoken English includes pronunciation, intonation, stress, and fluency - how words are produced naturally in conversation, presentations, and dialogue. Written English encompasses grammar, spelling, punctuation, and structure - the formal conventions of written expression. Both forms require understanding audience, context, and purpose. Spoken communication is immediate and personal, allowing for gesture, tone, and real-time feedback. Written communication is permanent and formal, requiring clarity, organization, and careful word choice. Success in academic and professional settings depends on mastering both forms. This topic provides foundation for all subsequent English language skills."
            },
            {
                title: "Grammar Fundamentals",
                explanation: "Grammar is the system of rules governing English language structure. Key components include parts of speech (nouns, verbs, adjectives, etc.), sentence structure (subject-verb-object), verb tenses (past, present, future), and agreement (subject-verb agreement, pronoun-antecedent agreement). Understanding grammar enables correct and clear communication. Common grammatical structures include simple sentences (one independent clause), compound sentences (multiple independent clauses), complex sentences (independent + dependent clauses), and compound-complex sentences. Verb tenses show when actions occur: simple present, present continuous, simple past, past continuous, present perfect, past perfect. Proper grammar use demonstrates education, clarity of thought, and respect for the audience. Strong grammar skills are essential for writing, public speaking, and professional communication."
            },
            {
                title: "Vocabulary Development and Word Usage",
                explanation: "Vocabulary is the set of words one knows and uses in communication. Word choice affects meaning, tone, and effectiveness of communication. Vocabulary development involves learning new words, understanding their meanings, appropriate contexts for use, and related word forms (synonyms, antonyms, word families). Context clues help determine word meaning in reading. Word roots (Latin, Greek) and affixes (prefixes, suffixes) help decode unfamiliar words. Synonyms are words with similar meanings but different connotations; antonyms are opposites. Homophones (same sound, different meaning: 'there/their/they're') and homographs (same spelling, different meaning: 'lead' as metal vs. 'lead' as guide) cause confusion. Connotation (emotional association) differs from denotation (literal meaning). Expanding vocabulary improves reading comprehension, writing quality, and ability to express complex ideas precisely."
            },
            {
                title: "Reading Comprehension and Analysis",
                explanation: "Reading comprehension involves understanding and interpreting written texts. Key skills include identifying main ideas, supporting details, author's purpose, tone, and point of view. Pre-reading strategies include previewing (scanning headings, summaries), predicting content, and activating prior knowledge. During reading, annotation (highlighting, notes, questioning) aids comprehension. Post-reading includes summarizing, discussing, and applying information. Different text types require different approaches: narratives emphasize plot and character, expository texts present information, persuasive texts use arguments, and academic texts require critical analysis. Critical reading involves questioning the text: Who wrote it? What's the purpose? Is it credible? What's the evidence? Reading actively, rather than passively, builds comprehension and critical thinking. Strong reading skills enable academic success and lifelong learning."
            },
            {
                title: "Writing Skills and Composition",
                explanation: "Writing is expressing ideas clearly and effectively on paper. The writing process includes prewriting (brainstorming, organizing), drafting (getting ideas down), revising (improving content and organization), editing (correcting errors), and publishing. Different writing forms serve different purposes: narrative writing tells stories, descriptive writing creates vivid images, expository writing explains concepts, persuasive writing convinces readers, and argumentative writing presents and defends positions using evidence. Essential writing skills include thesis development (clear main idea), paragraph structure (topic sentence + supporting sentences), transitions (connecting ideas), and conclusion. Proper paragraph structure includes topic sentence, supporting sentences with evidence or examples, and concluding sentence. Good writing is clear (easy to understand), concise (no unnecessary words), and coherent (ideas logically connected). Revising and editing are critical - first drafts rarely achieve final quality. Strong writing skills are essential for academic essays, professional emails, job applications, and personal expression."
            },
            {
                title: "Listening and Spoken English",
                explanation: "Listening is an active skill requiring attention, comprehension, and response. Effective listening involves focusing on the speaker, minimizing distractions, and understanding both literal meaning and implied meaning. Note-taking helps retain information. Spoken English includes correct pronunciation (how sounds are produced), stress (emphasis on syllables), intonation (pitch patterns in sentences), and fluency (smooth, natural speech). Pronunciation affects clarity - mispronounced words may be misunderstood. Stress changes meaning: 'REcord' (noun) vs. 're-CORD' (verb). Intonation conveys emotion and intention - rising pitch at end suggests a question. Fluency involves speaking smoothly, maintaining appropriate pace, and avoiding excessive pauses. Public speaking requires additional skills: voice projection, eye contact, gestures, and organization. Listening and speaking are interdependent - good listeners become better speakers, and clear speakers facilitate listening. These skills are crucial for classroom participation, presentations, interviews, and social interaction."
            },
            {
                title: "Punctuation and Mechanics",
                explanation: "Punctuation marks are symbols that clarify meaning in written English. Periods end sentences and indicate abbreviations. Commas separate items, separate clauses, and clarify meaning. Semicolons connect independent clauses without conjunctions. Colons introduce lists or explanations. Apostrophes show possession ('s) or contractions (don't = do not). Quotation marks set off quoted material. Parentheses provide additional information. Dashes (—) create emphasis. Exclamation marks end emphatic statements. Question marks end questions. Proper punctuation prevents ambiguity: 'Let's eat, Grandma' (call grandma to eat) vs. 'Let's eat Grandma' (suggests cannibalism). Mechanics include capitalization (proper nouns, sentence beginnings), spelling, italics (for titles, emphasis), and underlining. Numbers may be spelled out or written as numerals depending on context. Consistency in mechanics enhances professionalism. Understanding punctuation and mechanics prevents misunderstanding and demonstrates writing competence."
            },
            {
                title: "Academic English Skills",
                explanation: "Academic English is formal, objective language used in educational and professional contexts. It differs from casual English through vocabulary formality, sentence complexity, and objectivity. Academic writing features clear thesis statements, organized arguments with evidence, transitions between ideas, formal tone (avoiding contractions and slang), and proper citations of sources. Key academic skills include summarizing (condensing main ideas), paraphrasing (restating ideas in your own words), synthesizing (combining information from multiple sources), and quoting (using exact source words). Critical thinking is essential - evaluating information credibility, identifying bias, recognizing assumptions, and forming reasoned judgments. Academic integrity requires giving credit to sources through citations (MLA, APA, Chicago styles). Research skills include locating reliable sources, evaluating them for credibility, taking notes efficiently, and integrating sources properly. Academic English enables success in college courses, professional writing, and intellectual discourse."
            }
        ]
    }
];
